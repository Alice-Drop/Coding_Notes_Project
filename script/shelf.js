...
function display_shelf(data, shelf_obj, as_param="", shelf_title=""){
    // 把那些文章数据渲染到上面去
    ...
    if (shelf_title){
        console.log(shelf_title);
        
        let title_row = document.createElement("tr");
        articles_shelf.appendChild(title_row);
        let title = document.createElement("td");
        title.innerHTML = `<h3>${shelf_title}</h3>`
